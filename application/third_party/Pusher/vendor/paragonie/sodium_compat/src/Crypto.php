...
abstract class ParagonIE_Sodium_Crypto {
    ...
    $message = '', $ad = '', $nonce = '', $key = ''
        ...
        return ParagonIE_Sodium_Core_ChaCha20::streamXorIc(
                        $ciphertext, $nonce, $key, ParagonIE_Sodium_Core_Util::store64_le(1)
        );
    }
    ...
    $message = '', $ad = '', $nonce = '', $key = ''
        ...
        $ciphertext = ParagonIE_Sodium_Core_ChaCha20::streamXorIc(
                        $message, $nonce, $key, ParagonIE_Sodium_Core_Util::store64_le(1)
        );
    ...
    $message = '', $ad = '', $nonce = '', $key = ''
        ...
        $subkey = ParagonIE_Sodium_Core_HChaCha20::hChaCha20(
                        ParagonIE_Sodium_Core_Util::substr($nonce, 0, 16), $key
        );
    ...
    public static function secretbox($plaintext, $nonce, $key) {
        ...
        $block0 = ParagonIE_Sodium_Core_Salsa20::salsa20_xor(
                        $block0, ParagonIE_Sodium_Core_Util::substr($nonce, 16, 8), $subkey
        );
        ...
        if ($mlen > $mlen0) {
            $c .= ParagonIE_Sodium_Core_Salsa20::salsa20_xor_ic(
                            ...
                            ), ParagonIE_Sodium_Core_Util::substr($nonce, 16, 8), 1, $subkey
            );
        }
    ...
    public static function secretbox_open($ciphertext, $nonce, $key) {
        ...
        $block0 = ParagonIE_Sodium_Core_Salsa20::salsa20(
                        64, ParagonIE_Sodium_Core_Util::substr($nonce, 16, 8), $subkey
        );
        $verified = ParagonIE_Sodium_Core_Poly1305::onetimeauth_verify(
                        $mac, $c, ParagonIE_Sodium_Core_Util::substr($block0, 0, 32)
        );
        if (!$verified) {
            try {
                ParagonIE_Sodium_Compat::memzero($subkey);
        ...
        $m = ParagonIE_Sodium_Core_Util::xorStrings(
                        ParagonIE_Sodium_Core_Util::substr($block0, self::secretbox_xsalsa20poly1305_ZEROBYTES), ParagonIE_Sodium_Core_Util::substr($c, 0, self::secretbox_xsalsa20poly1305_ZEROBYTES)
        );
        if ($clen > self::secretbox_xsalsa20poly1305_ZEROBYTES) {
            ...
            $m .= ParagonIE_Sodium_Core_Salsa20::salsa20_xor_ic(
                            ...
                            ), ParagonIE_Sodium_Core_Util::substr($nonce, 16, 8), 1, (string) $subkey
            );
        }
        return $m;
    }
    ...
    public static function secretbox_xchacha20poly1305($plaintext, $nonce, $key) {
        ...
        if ($mlen > $mlen0) {
            $c .= ParagonIE_Sodium_Core_ChaCha20::streamXorIc(
                            ...
                            ), $nonceLast, $subkey, ParagonIE_Sodium_Core_Util::store64_le(1)
            );
        }
        $state = new ParagonIE_Sodium_Core_Poly1305_State(
                ParagonIE_Sodium_Core_Util::substr(
    ...
    public static function secretbox_xchacha20poly1305_open($ciphertext, $nonce, $key) {
        ...
        /** @var string $m - Decrypted message */
        $m = ParagonIE_Sodium_Core_Util::xorStrings(
                        ParagonIE_Sodium_Core_Util::substr($block0, self::secretbox_xchacha20poly1305_ZEROBYTES), ParagonIE_Sodium_Core_Util::substr($c, 0, self::secretbox_xchacha20poly1305_ZEROBYTES)
        );
        ...
        if ($clen > self::secretbox_xchacha20poly1305_ZEROBYTES) {
            ...
            $m .= ParagonIE_Sodium_Core_ChaCha20::streamXorIc(
                            ...
                            ), ParagonIE_Sodium_Core_Util::substr($nonce, 16, 8), (string) $subkey, ParagonIE_Sodium_Core_Util::store64_le(1)
            );
        }
        return $m;
    }
