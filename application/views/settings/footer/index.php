            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <i class="fa fa-info-circle"></i> <?php echo lang("footer_description_message"); ?>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="enable_footer" class=" col-md-2"><?php echo lang('enable_footer'); ?></label>
                        <div class="col-md-10">
                            <?php
                            echo form_checkbox("enable_footer", "1", get_setting("enable_footer") ? true : false, "id='enable_footer' class='ml15'");
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="footer-details-area" class="<?php echo get_setting("enable_footer") ? "" : "hide"; ?>">
                        <div class="form-group" id="footer-menu-input-area">
                            <label for="footer_menus" class=" col-md-2"><?php echo lang('footer_menus'); ?></label>
                            <div class="col-md-10">
                                ...
                                <div class="row">
                                    ...
                                    <div id="footer-menus-options-area" class="col-md-12 mt15 hide">
                                        <button id="footer-menus-add-button" type="button" class="btn btn-primary"><span class="fa fa-check-circle"></span> <?php echo lang('add'); ?></button> 
                                        <button id="footer-menus-close-button" type="button" class="btn btn-default"><span class="fa fa-close"></span> <?php echo lang('cancel'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="footer_copyright_text" class=" col-md-2"><?php echo lang('footer_copyright_text'); ?></label>
                            <div class="col-md-10">
                                <?php
                                echo form_input(array(
                                    ...
                                    "class" => "form-control",
                                    "placeholder" => lang('footer_copyright_text')
                                ));
                                ?>
                            </div>
                        </div>
