...
class ParagonIE_Sodium_Core_Poly1305_State extends ParagonIE_Sodium_Core_Util {
    ...
    public function update($message = '') {
        ...
        if ($this->leftover) {
            ...
            $this->blocks(
                    static::intArrayToString($this->buffer), ParagonIE_Sodium_Core_Poly1305::BLOCK_SIZE
            );
            $this->leftover = 0;
        }
    ...
    public function blocks($message, $bytes) {
        ...
        while ($bytes >= ParagonIE_Sodium_Core_Poly1305::BLOCK_SIZE) {
            ...
            $message = self::substr(
                            $message, ParagonIE_Sodium_Core_Poly1305::BLOCK_SIZE
            );
    ...
    public function finish() {
        ...
        if ($this->leftover) {
            ...
            $this->blocks(
                    self::substr(
                            static::intArrayToString($this->buffer), 0, ParagonIE_Sodium_Core_Poly1305::BLOCK_SIZE
